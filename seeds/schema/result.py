...
class SeedAccountResult(BaseModel):
    ...
    Attributes:
        ...
        transfer_operations (list[SeedOperationResult]): Список операций пперевода средств.
        cash_withdrawal_operations (list[SeedOperationResult]): Список операций выдачи наличных.
    """
    account_id: str
