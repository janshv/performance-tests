...
class CardsGatewayGRPCClient(GRPCClient):
    """
    gRPC-клиент для взаимодействия с CardsGatewayGRPCClient.
    ...
    def __init__(self, channel: Channel):
        ...
        :param channel: gRPC-канал для подключения к CardsGatewayGRPCClient.
        """
    ...
    def issue_virtual_card_api(self, request: IssueVirtualCardRequest) -> IssueVirtualCardResponse:
        ...
        :param request: gRPC-запрос с данными счёта.
        :return: Ответ от сервиса с данными выпущенной карты.
        """
    ...
    def issue_physical_card_api(self, request: IssuePhysicalCardRequest) -> IssuePhysicalCardResponse:
        ...
        :param request: gRPC-запрос с gRPC-запрос с данными счёта.
        :return: Ответ от сервиса с данными выпущенной карты.
        """
    ...
    def issue_virtual_card(self, user_id: str, account_id: str) -> IssueVirtualCardResponse:
        """
        Выпуск виртуальной карты для указанных user_id, account_id.
...
# билдер для нагрузочного тестирования
